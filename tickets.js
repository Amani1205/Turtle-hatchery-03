...
function clearStorage(){
  ...
  localStorage.setItem("book_duration","1hr(01 Normal:00 Peak)");
  localStorage.setItem("Time","07.00am-08.00am");
  CalTotalPayable();
...
date.addEventListener('change', () => {
    ...
    // Enable the continue button only if a valid date is selected
    if (selectedDate) {
